...
#FAAS Data
AA_imported <- read.csv("~/RStudio/Projects/Chem311_JCWS/data/AA_Data.csv", skip=4) 
...
#Sample Key
sample_key_imported <- read.csv("~/RStudio/Projects/Chem311_JCWS/data/Sample_Key.csv", skip=0)
...
remove(corrected, ICPMS_merged, ICPMS_tidy, ISTD, RSD_Data, sample, RSD_data, ID)
```
