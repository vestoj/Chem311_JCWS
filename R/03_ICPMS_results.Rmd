...
Cd114 <-  ggplot(Cd114, aes(site, conc.blanked))+ 
  geom_col(fill="#003300")+
  labs(title="Concentration of Cd114 in Johnson Creek Watershed Sites",
        y= "Concentration of Cd114 (ppm)", #double check unit!!
        x="Site along Johnson Creek Watershed")+     
  geom_errorbar(ymin= Cd114$conc.blanked - Cd114$conc.blanked.error,
                max= Cd114$conc.blanked + Cd114$conc.blanked.error)+
  coord_cartesian(ylim = c(0, 350))
print(Cd114)
