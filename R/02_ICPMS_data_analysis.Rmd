...
sample_data <- merge(ICPMS,sample_data)%>%
  unique()%>%
  mutate(conc.blanked= conc.dil.blanked*(total.volume/1000)/(mass.soil/1000*1000))%>%
  mutate(conc.unblanked= concentration.diluted*(total.volume/1000)/(mass.soil/1000*1000))%>%
